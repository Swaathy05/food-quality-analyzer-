...
class FoodAnalyzer:
    ...
    def analyze_nutrition_and_chemicals(self, nutrition_text, health_profile):
        ...
        if not self.llm:
            return "AI analysis unavailable. Please check your GROQ_API_KEY."
        ...
        prompt = PromptTemplate.from_template(
            ...
            7. **NOVI SCORE**: Provide a nutrition quality score

            ### RESPONSE FORMAT:
            Provide a clear, structured analysis that's easy to understand.
            """
        )
...
def create_streamlit_app():
    ...
    with col1:
        ...
        if uploaded_file is not None:
            ...
            # Extract text button
            if st.button("🔍 Analyze Nutrition Label", type="primary"):
    ...
    with st.expander("📋 How to Use"):
        st.markdown("""
        1. **Set up your health profile** in the sidebar (allergies, dietary restrictions, etc.)
        2. **Upload a clear image** of a nutrition facts label
        3. **Click 'Analyze'** to extract text and get comprehensive analysis
        4. **Ask specific questions** about the product for personalized advice
        
        **Tips for best results:**
        - Use well-lit, clear images
        - Ensure the nutrition label is fully visible
